...
def test_option_outputformat_table(
        hmc_name, hmc_version, api_version, out_opt, out_format,
    ...
    try:
        ...
        if logdest_value == 'syslog':
            ...
            if syslog_lines:
                ...
                logger_lines = logger_lines[-len(LOG_API_DEBUG_PATTERNS):]
