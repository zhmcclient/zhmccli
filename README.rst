...
.. image:: https://travis-ci.org/zhmccli/python-zhmccli.svg?branch=master
    :target: https://travis-ci.org/zhmccli/python-zhmccli
    :alt: Travis test status (master)

.. image:: https://ci.appveyor.com/api/projects/status/i022iaeu3dao8j5x/branch/master?svg=true
    :target: https://ci.appveyor.com/project/leopoldjuergen/python-zhmccli
    :alt: Appveyor test status (master)

.. image:: https://readthedocs.org/projects/python-zhmccli/badge/?version=latest
    :target: http://python-zhmccli.readthedocs.io/en/latest/
    :alt: Docs build status (latest)

.. image:: https://img.shields.io/coveralls/zhmccli/python-zhmccli.svg
    :target: https://coveralls.io/r/zhmccli/python-zhmccli
    :alt: Test coverage (master)

.. image:: https://codeclimate.com/github/zhmccli/python-zhmccli/badges/gpa.svg
    :target: https://codeclimate.com/github/zhmccli/python-zhmccli
    :alt: Code Climate
...
.. _Installation section: http://python-zhmccli.readthedocs.io/en/stable/intro.html#installation
...
.. _Documentation for latest version on Pypi: http://python-zhmccli.readthedocs.io/en/stable/
.. _Documentation for master branch in Git repo: http://python-zhmccli.readthedocs.io/en/latest/
...
.. _Development section: http://python-zhmccli.readthedocs.io/en/stable/development.html
...
.. _Apache 2.0 License: https://github.com/zhmcclient/python-zhmccli/tree/master/LICENSE
